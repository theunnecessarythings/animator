...
//         if (oldName != newName) {
//           m_undoStack->push(new ChangeNameCommand(this, e, oldName,
//           newName));
//         }
//       }
//     });
...
//
//       // When the user finishes typing and hits Enter or clicks away, we
//       reset
...
//                     stateOnBegin->rotation, stateOnBegin->sx,
//                     stateOnBegin->sy, newState.x, newState.y,
//                     newState.rotation, newState.sx, newState.sy));
//               });
//
...
//               old_sc.updateFunction, old_sc.destroyFunction,
//               new_sc.scriptPath, new_sc.startFunction, new_sc.updateFunction,
...
//                                            float newRotation) {
//   m_isDragging = false;
//   m_undoStack->push(new MoveEntityCommand(this, entity, oldX, oldY,
//   oldRotation,
...
void MainWindow::onPaste() {
  ...
  QJsonObject wrapper;
  wrapper["entities"] = doc.array();

  Scene &scene = m_canvas->scene();
  scene.deserialize(wrapper);
